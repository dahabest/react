- [Обычная локальная переменная в компоненте](#Локальная-переменная)
- [Что такое хуки](#Что-такое-хуки)
- [Нескольких переменных состояния в одном компоненте](#Нескольких-переменных-состояния)
...
## Нескольких переменных состояния
